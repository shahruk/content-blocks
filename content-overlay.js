...
import { g as getCurrentValue, b as generateResponsiveClass } from './utils.js';
...
const ContentOverlay$1 = class extends HTMLElement {
  constructor() {
    super();
    this.__registerHost();
    this.contentOverlayActivated = createEvent(this, "contentOverlayActivated", 7);
    /**
     * @type Boolean
     * @responsive
     */
  ...
  render() {
    return (h(Host, { class: this.activeClass }, h("div", { ref: element => this.dialogElement = element, role: "dialog", "aria-modal": "true", class: "hidden", "aria-expanded": "false" }, h("div", { class: "content-overlay__header" }, h("button", { onClick: e => this.closeOverlayButtonClicked(e), class: "content-overlay__close", title: this.closeTitle }, h("slot", { name: "closeButton" })), h("slot", { name: "header" })), h("slot", { name: "content" }), h("div", { ref: element => this.contentElement = element, class: `content-overlay__content ${generateResponsiveClass('content-overlay-vertical-position', this.verticalAlignment)} ${generateResponsiveClass('content-overlay-horizontal-position', this.horizontalAlignment)}` }))));
  }
  get hostElement() { return this; }
  static get style() { return contentOverlayCss; }
};

const ContentOverlay = /*@__PURE__*/proxyCustomElement(ContentOverlay$1, [4,"content-overlay",{"target":[1],"fullScreen":[1,"full-screen"],"styleClass":[1,"style-class"],"horizontalAlignment":[1,"horizontal-alignment"],"verticalAlignment":[1,"vertical-alignment"],"closeTitle":[1,"close-title"],"isActive":[32],"activeClass":[32]},[[8,"contentBlockActivated","onContentBlockActivated"],[0,"ariaDialog.closed","onAriaDialogClosed"]]]);
